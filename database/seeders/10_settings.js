...
const seedSettings = async () => {
  ...
  await Setting.insertMany([
    ...
    { key: 'homepage_hero_heading',value: 'Craft your legacy in Stone, Metal & Wood',                              group: 'homepage', label: 'Hero Heading',                 type: 'string' },
    { key: 'homepage_hero_subtext',value: "Crafted in Stone & Metal. Designed to Endure.\nBespoke engravings created with precision, craftsmanship, and an uncompromising eye for detail.", group: 'homepage', label: 'Hero Subtext', type: 'string' },
